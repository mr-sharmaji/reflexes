	...
	if (document.getElementById('map')) {
		...
		function init() {
			...
			var mapOptions = {
				...
				center: new google.maps.LatLng(22.594459,  88.341785), // reflexes

				// How you would like to style the map.
				// This is where you would paste any style Maps.
				styles: [
					{
						featureType: 'water',
			...
			var marker = new google.maps.Marker({
				position: new google.maps.LatLng(22.594459,  88.341785),
				map: map,
				title: 'Reflexes!'
			});
		}
